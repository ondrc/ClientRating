...
startNodeManager(NodeManagerHome=nodemanager_path, ListenPort='5556', ListenAddress='localhost', NativeVersionEnabled='false', block='true', username='weblogic', password='welcome1', domainName='domain')
