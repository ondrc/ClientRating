...
edit()
startEdit()
redeploy(appName='RatingService', planPath='../build/plans/RatingServicePlan.xml', partition='Partition-0')
redeploy(appName='CustomerService', planPath='../build/plans/CustomerServicePlan.xml', partition='Partition-1')
redeploy(appName='FinancialRecordsService', planPath='../build/plans/FinancialRecordsServicePlan.xml', partition='Partition-3')
activate()